  ...
  <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
    ...
    <form className="max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto">
      <div>
        ...
        <input
          name="first-name"
          className="w-full bg-gray-50      border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2"
        />
      </div>
      <div>
        <label
      ...
      <div className="sm:col-span-2">
        ...
        <textarea
          name="message"
          className="w-full h-64 bg-gray-50      border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2"
          defaultValue={""}
        />
      </div>
      <div className="sm:col-span-2 flex justify-between items-center">
        <button className="inline-block bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300    text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
          Send
        </button>
